            ...
            <div className="square-content align-self-center ">
              ...
              <div className="image-box">
                ...
                <p className="square-content-text overlay centered">
                  ...
                  are born on this earth you are born along with prana, living
                  with breath. In the same prana a divine form- the divinity,
                  also comes along with you. For you, under the illusion that
                  you are the jeevatma in the external world, that divine
                  consciousness gives a form - “I”. The path to the divine
                  consciousness from the “I” which is formed from the same
                  divine consciousness- is spirituality. That is YOU.
                </p>
              </div>
            </div>
          </div>
            ...
            <div className="square-content align-self-center ">
              ...
              <div className="image-box">
                ...
                <p className="square-content-text overlay centered">
                  ...
                  life is happening inside of you.
                </p>
              </div>
            </div>
          </div>
            ...
            <div className="square-content align-self-center">
              ...
              <div className="image-box">
                ...
                <p className="square-content-text overlay centered">
                  ...
                  coordinate your Manas(mind), Buddhi(intellect) Indriyas and
                  Gnanendriyas(5 senses of perception). When your sadana takes
                  you from this state of harmony between Manas, Buddhi, Indriyas
                  and Gnanendriyas to the state of oneness , from the state of
                  oneness to the state of divinity and then it becomes complete.
                  To achieve that state, one has to work hard with self
                  discipline (internal & external) in their spiritual practice.
                </p>
              </div>
            </div>
          </div>
